      ...
      <span className="group relative inline-flex items-center gap-1.5 align-baseline">
        <DialogTrigger asChild>
          <button
            ...
            className={`cursor-pointer bg-transparent p-0 text-left align-baseline hover:underline focus-visible:rounded-sm focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-[#4a2e8a] ${className}`}
          >
            {name}
          </button>
        </DialogTrigger>
